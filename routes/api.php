...
Route::prefix('product')->group(function () {
    ...
    Route::get('most-sold', [ProductController::class, 'mostSoldProduct']);
...
Route::prefix('statistic')->group(function () {
    ...
    Route::get('point', [\App\Http\Controllers\PointTransactionController::class, 'pointHistory'])->middleware('auth:sanctum', 'admin');
});
